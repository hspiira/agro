...
export const products = [
  {
    ...
    body: "Single origin, sun-dried on raised beds. Mubende altitude 1,300m.",
    price: "UGX 48,000",
    unit: "kg",
    badge: "Best Seller",
    tone: "accent",
  },
  {
    ...
    body: "Matooke & sweet varieties. Harvested to order, delivered within 24hrs.",
    price: "UGX 20,000",
    unit: "bunch",
    badge: "Fresh",
    tone: "green",
  },
  {
    ...
    body: "Ankole-Friesian cross, pasture-raised. Fillet, sirloin & stew cuts available.",
    price: "UGX 22,000",
    unit: "kg",
    badge: "Order Ahead",
    tone: "muted",
  },
  {
    ...
    body: "Freshly roasted, medium-dark profile. Ground or whole bean.",
    price: "UGX 32,000",
    unit: "500g",
    badge: "New",
    tone: "green",
